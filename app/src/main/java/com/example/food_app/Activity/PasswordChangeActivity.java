    ...
    private void bottomNavigation() {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PasswordChangeActivity.this, CartListActivity.class);
                startActivity(intent);
            }
        });
...
//            startActivity(intent);
            ...
            Intent intent = new Intent(PasswordChangeActivity.this, LoginMainActivity.class);
