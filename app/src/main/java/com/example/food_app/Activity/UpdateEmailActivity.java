...
public class UpdateEmailActivity extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateEmailActivity.this, CartListActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_refresh) {
            ...
            Intent intent = new Intent(UpdateEmailActivity.this, FavoriteActivity.class);
            startActivity(intent);
            finish();
...
//            startActivity(intent);
            ...
            Intent intent = new Intent(UpdateEmailActivity.this, LoginMainActivity.class);
